  ...
  const signInPhoneOtp = useCallback(
    async (options: LoginWithPhoneOtpOptions): Promise<PhoneOtpAuthResult> => {
      try {
        ...
        const error =
          e instanceof OpenfortError ? e : new AuthenticationError('phone_otp_error', 'Failed to login with phone OTP')
  ...
  const requestPhoneOtp = useCallback(
    async (options: RequestPhoneOtpOptions): Promise<PhoneOtpAuthResult> => {
      try {
        ...
        const error =
          e instanceof OpenfortError ? e : new AuthenticationError('phone_otp_error', 'Failed to request phone OTP')
